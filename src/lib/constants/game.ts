...
export const binPayouts: Record<RowCount, Record<RiskLevel, number[]>> = {
  ...
  16: {
    [RiskLevel.EZ]: [1000000, 1000000, 1000000, 1000000, 1000000, 1000000, 1000000, 1000000, 1, 1000000, 1000000, 1000000, 1000000, 1000000, 1000000, 1000000, 1000000],
    [RiskLevel.LOW]: [16, 9, 2, 1.4, 1.4, 1.2, 1.1, 1, 10000, 1, 1.1, 1.2, 1.4, 1.4, 2, 9, 16],
